  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?> role="article" itemscope itemprop="blogPost" itemtype="http://schema.org/VideoObject">
    ...
    <header class="entry-header">
      ...
      <p class="entry-date">
        ...
        <time class="updated entry-time" datetime="<?php echo get_the_time('Y-m-d'); ?>" itemprop="datePublished"><?php echo get_the_date(); _e( ' at ', 'molde-theme' ); echo get_the_date('H:i'); ?></time>
      </p>
